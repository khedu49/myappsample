...
(function(){
  ...
  firebase.initializeApp(config);
    ...
    const recAddressId = document.getElementById("locId");
...
if(name.value.length != 0 && recEmailId.value.length != 0 && recPassId.value.length != 0 && recRenPassId.value.length != 0)
{
...
else
{
  alert("Please fill all the details.");
    ...
    function saveMessage1() {
      ...
      firebase.firestore().collection('teachers').doc(getEmail1).set({
        name: name.value,
